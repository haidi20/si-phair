...
class AttendanceExport implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithDrawings
{
    ...
    {
        return 'Laporan Absensi Karyawan';
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // BAGIAN : TANGGAL
        $sheet->getStyle('C3:AG3')->applyFromArray([
            'fill' => [
                'fillType' => 'solid',
                'rotation' => 0,
                'color' => ['rgb' => '000000'],
