...
@section('content')
@include('pages.master.company.partials.modal')
...
<script>
    ...
    $(document).ready(function() {
        ...
        state.companies = {!! json_encode($companies) !!};
        send();
    });

    function onCreate() {
        clearForm();
        $("#titleForm").html("Tambah Perusahaan");
    ...
    function onEdit(data) {
        ...
        $("#titleForm").html("Ubah Perusahaan");
        onModalAction("formModal", "show");
    }
    ...
    function onDelete(data) {
        Swal.fire({
            title: 'Perhatian!!!',
            html: `Anda yakin ingin hapus data perusahaan <h2><b> ${data.name} </b> ?</h2>`,
            icon: 'warning',
