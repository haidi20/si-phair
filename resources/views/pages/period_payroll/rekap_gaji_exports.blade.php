...
<table>
    ...
    <tr>
        ...
        <td data-format="#,##" align="right">{{$p->pendapatan_tambahan_lain_lain - $p->tambahan_baru_untuk_incentive_rekap}}</td>
        <td data-format="#,##" align="right">{{$p->tambahan_baru_untuk_incentive_rekap}}</td>
        ...
        <td data-format="#,##" align="right">{{($p->pemotongan_potongan_lain_lain - $p->jumlah_hutang)}}</td>
