    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            ...
            <div class=" d-flex flex-column align-items-center logo">
                <div style="height: 5rem !important;">
                    {{-- <img src="{{ asset('assets/img/logo.png') }}" alt="" > --}}
                </div>
                <div class="fw-bold mt-2 ms-3" style="font-size: 1.5rem;">SI PH AIR</div>
                <span style="font-size: 10px;">Sistem informasi monitoring ph air</span>
            </div>
